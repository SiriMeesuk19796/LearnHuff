function handleSearch() {
    ...
    const baseURL = window.location.origin; // ใช้ base URL ของเว็บไซต์
    const url_format = baseURL + "/LearnHuff/ContentPage/Format_ContentPage.html"; // เพิ่มเส้นทางที่ต้องการให้ถูกต้อง
    const topics = [
